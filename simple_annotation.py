"""
Simple Command-Line Annotation Helper
Quick annotation tool for VLM safety training data
"""
...
class SimpleAnnotationHelper:
    ...
    def display_image(self, image_path):
        """Display image using default system viewer"""
        try:
    ...
    def run(self):
        ...
        print("VLM Safety Annotation Helper")
        print("=" * 40)
